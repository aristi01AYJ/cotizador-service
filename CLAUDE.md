...
- **07-sep-2026 — Bloque "Exclusiones" del PDF tenía texto de Software, no de Servicios.** `generarPDF()` (~línea 2138) traía la lista de exclusiones copiada de `cotizador-software` (licencias, Windows, antivirus, hardware de PC) — se reemplazó por el listado propio de servicios técnicos (alcance, materiales, trabajos civiles/eléctricos, desmontajes, fallas preexistentes, transporte especial, horas extra, certificaciones, demoras del cliente).
  - **Pendiente relacionado, no tocado todavía:** el bloque "Condiciones Comerciales" justo arriba de Exclusiones (~línea 2126-2131) también parece copiado de Software — habla de "Entrega de licencias 2 a 5 días hábiles", "System Requirements iX 2025", "Entrega digital para descarga online. Licenciamiento web. No se realiza entrega física" — nada de esto aplica a un servicio técnico/mantenimiento. Revisar con el usuario y corregir si confirma.
